...
const SalesResumeScreen = () => {
  ...
  return (
    <Stack spacing={2} sx={{ width: "100%" }}>
      <Card>
        {" "}
        <h1>Reporte de ventas de articulos por ruta</h1>
        <p>Resumen de  articulos vendidos por ruta de distribucion</p>
      </Card>

      <Card>
        <h3>Filtros</h3>
        <RouteDistributionDropDown
          value={route}
      ...
      <MUIDataTable
        title="Resumen ventas por Articulos"
        data={data}
        columns={columns}
        options={options}
      />
...
export default SalesResumeScreen;
